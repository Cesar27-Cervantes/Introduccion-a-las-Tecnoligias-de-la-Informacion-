					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								...
								<li class="nav-item"><a href="../../../../layout_2/LTR/default/full/index.html" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="../../../../layout_3/LTR/default/full/index.html" class="nav-link"></a></li>
								<li class="nav-item"><a href="../../../../layout_4/LTR/default/full/index.html" class="nav-link">Listado</a></li>
								<!-- Main --
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						 <code></code>Esta es la tabla de empleados  <strong></strong>
					</div>
					...
					<table class="table datatable-basic">
						<thead>
							<tr>
									...
									<th>Direccion</th>
									<th>Departamento</th>
									<th>Direccion Del Departamento</th>
						...
						<tbody>
							<tr>
								<td>1</td>
								<td>Eugene</td>
								<td><a href="#">Kopyov</a></td>
								<td>30420</td>
								<td>Costurero</td>
								<td><span class="badge badge-success">Calle Verde</span></td>
		
								<td><a center="#">Textiles</a></td>
								<td>Aula 2</td>
							...
							<tr>
								...
								<td>Victoria</td>
								<td>Baker</td>
								<td><a href="#">30471</a></td>
								<td>Barrer</td>
								<td><span class="badge badge-secondary">Calle Verde</span></td>
								
								<td><a center="#">Limpieza</a></td>
								<td>Aula 7</td>	
									<!--com--<div class="list-icons">
										<div class="dropdown">
