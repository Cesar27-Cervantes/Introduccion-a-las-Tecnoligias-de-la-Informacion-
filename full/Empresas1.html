					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								...
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/index.html" class="nav-link">Listado</a></li>
								<!-- Main --
								<li class="nav-item"><a href="../../../../layout_5/LTR/default/full/index.html" class="nav-link">Layout 5</a></li>
								<li class="nav-item"><a href="../../../../layout_6/LTR/default/full/index.html" class="nav-link disabled">Layout 6 <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li><-- Main /-->
							</ul>
						</li>
						<!-- Main -->
						<li class="nav-item nav-item-submenu">
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						 <code></code>Esta es el listado de Empresas <strong></strong>
					</div>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							<tr>
								...
								<td>1145</td>
								<td>55-45-5745-00</td>
								<td>Calle los Cerezos</td>
		
								<td><a center="#">Asa Griggs Candler</a></td>
								<td>5</td>
								
									<!--com--<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" Limoieza"dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a href="#" class="dropdown-item"><i class="icon-file-word"></i> Export to .doc</a><!-- /com -->
											</div>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>1249</td>
								<td>54-48-528-07</td>
								<td>Calle estado hidalgo</td>
								
								<td><a center="#">Caleb Davis Bradham</a></td>
								<td>4</td>	
									<!--com--<div class="list-icons">
										<div class="dropdown">
							...
							<tr>
								...
								<td>11894</td>
								<td>56-78-3450-30</td>
								<td>Calle de la Unidad</td>
								
								<td><a center="#">Lee Byung-chul</a></td>
								<td>3</td>	
									<!--com--
									<div class="list-icons">
										<div class="dropdown">
							...
							<tr>
								...
								<td>21764</td>
								<td>59-14-5742-00</td>
								<td>Calle Fransisco Villa</td>
								
								<td><a center="#">Henry Ford</a></td>
								<td>17</td>		
									<!--com--
									<div class="list-icons">
										<div class="dropdown">
