			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Periodo Vacaccional Empleados</h5>
					...
					<div class="card-body">
						<p class="mb-4"> <code>Este es el Formulario del el Periodo Vacaccional de los Empleados</code><code></code><code></code><code></code><code></code><code></code><code></code></p>

						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Formulario Periodo Vacaccional</legend>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Juan Banda">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Matricula</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="2011">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Periodo de Inicio</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="17/04/2017">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Periodo de Termino</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="04/05/2017">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Dias Laborales</label>
								<div class="col-lg-10">
					...
					<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Andrea Castillo">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Matricula</label>
							...
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Periono de Inicio</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="10/10/2018">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Periodo de Termino</label>
					...
					<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Hector Puga">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Matricula</label>
							...
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Periodo de Inicio</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="20/01/2019">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Periodo de Termino</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="10/02/2019">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Dias Laborales</label>
					...
					<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Emiliano Acuña">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Matricula</label>
							...
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Periodo de Inicio</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="01/04/2019">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Periodo de Termino</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="15/04/2019"
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Dias Laborales</label>
					...
					<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Assur Rocha">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Matricula</label>
							...
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Periodo de Inicio</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="01/06/2019">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Periodo de Termino</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="01/07/2019">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Dias Laborales</label>
