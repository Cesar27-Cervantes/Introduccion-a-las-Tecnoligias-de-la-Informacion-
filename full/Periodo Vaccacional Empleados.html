			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Periodo Vacaccional de Empleados</h5>
					...
					<div class="card-body">
						 <code></code>Esta es el listado del Periodo Vacaccional de los Empleados <strong></strong>
					</div>
