				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							...
							<a href="#" class="nav-link"><i class="icon-copy"></i> <span>Departamentos</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="index.html" class="nav-link active">Agregar</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/Empresas formulario.html" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/Empresas.html" class="nav-link">Listado</a></li>
						</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-copy"></i> <span>Habilidades</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="index.html" class="nav-link active">Agregar</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/index.html" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/Empresas.html" class="nav-link">Listado</a></li>
						</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-copy"></i>Empresas</i> <span></span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/Empresas agregar.html" class="nav-link active">Agregar</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/Empresas formulario.html" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/Empresas.html" class="nav-link">Listado</a></li>
						</ul>
						</li>
							<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-copy"></i>Periodo Vacaccional</i> <span></span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/Periodo vacaccional agregar.html" class="nav-link active">Agregar</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/Periodo vacacional empleados formulario.html" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/Periodo Vaccacional Empleados.html" class="nav-link">Listado</a></li>
						</ul>
						</li>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Formulario de Empresas</h5>
					...
					<div class="card-body">
						<p class="mb-4"> <code>Este es el Formulario de Empresa</code><code></code><code></code><code></code><code></code><code></code><code></code></p>

						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Formulario Empresas</legend>
							...
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Cantidad de empleados</label>
								<div class="col-lg-10">
							...
							<div class="form-group row">
								...
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="1145">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Telefono</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="55-45-5745-00">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Direccion</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Calle los Cerezos">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre del Dueño</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Asa Griggs Candler">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Numero de Departamentos</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="5">
								</div>
							</div>
					...
					<div class="form-group row">
							...
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Matricula</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="1249">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Telefono</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="54-48-528-07">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Direccion</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Calle estado hidalgo">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre del Dueño</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Caled Davis Bradham">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Numero de Departamentos</label>
					...
					<div class="form-group row">
							...
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Matricula</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="11894">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Telefono</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="56-78-3450-30">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Direccion</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Calle de la Unidad">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre del Dueño</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Lee Byung-chul">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Numero de Departamentos</label>
					...
					<div class="form-group row">
							...
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Matricula</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="21764">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Telefono</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="59-14-5742-00">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Direccion</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Calle Francisco Villa">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre del Dueño</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Henry Ford">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Numero de Departamentos</label>
					...
					<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Huawei">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Cantidad de empleados</label>
							...
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Matricula</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="1467">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Telefono</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="57-42-6678-70">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Direccion</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Primavera">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Nombre del Dueño</label>
								<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="Ren Zhengfei">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-lg-2">Numero de Departamentos</label>
